...
<p align="center">
  <b>监控可视化</b> · <b>智能告警</b> · <b>远程终端</b> · <b>文件管理</b> · <b>虚拟化采集</b> · <b>插件体系</b> · <b>AI 运维</b> · <b>网络安全管理</b> · <b>多节点集群</b>
</p>
...
| **AI 运维** | AI 助手对话、告警根因分析、报告生成，可配置大模型（LLM）；MCP 工具体系（危险操作人工审批） |
...
| **Agent 运维** | 任务下发（远程命令执行）、自动升级（服务端下发）、多节点故障转移、优雅退出、零停机更新 |
